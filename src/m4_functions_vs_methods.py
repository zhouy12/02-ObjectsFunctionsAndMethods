...
def try_methods_and_functions():
    ...
    ###########################################################################
    cute = rg.SimpleTurtle()
    cute.pen = rg.Pen('blue', 5)
    cute.backward(150)
    cute.speed = 1
    draw_many_squares(cute, 2, 100, 30)
    cute.speed = 5
    cute.pen.color = 'red'
    draw_many_squares(cute, 10, 50, 15)
    cute.speed = 100
    cute.pen.thickness = 35
    draw_many_squares(cute, 8, 300, 60)
    cute.pen.color = 'black'
    cute.pen.thickness = 3
    cute.pen_up()
    cute.backward(200)
    cute.pen_down()
    cute.draw_circle(30)
